...
import com.example.Foreigner.Models.ExtendedIngredient;
...
public class IngredientsAdapter extends RecyclerView.Adapter<IngredientsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull IngredientsViewHolder holder, int position) {
        ...
        Picasso.get().load("http://spoonocular.com/cdn/ingredients_100x100/"+list.get(position).image).into(holder.imageView_ingredients);
...
class IngredientsViewHolder extends RecyclerView.ViewHolder {
    ...
    public IngredientsViewHolder(@NonNull View itemView) {
        super(itemView);
        textView_ingredients_quantity = itemView.findViewById(R.id.textView_ingredients_name);
